...
mixin _$DataRadioStation {
  ...
  $DataRadioStationCopyWith<DataRadioStation> get copyWith =>
      _$DataRadioStationCopyWithImpl<DataRadioStation>(
          this as DataRadioStation, _$identity);
...
abstract mixin class $DataRadioStationCopyWith<$Res> {
  factory $DataRadioStationCopyWith(
          DataRadioStation value, $Res Function(DataRadioStation) _then) =
      _$DataRadioStationCopyWithImpl;
  @useResult
  $Res call(
      {String name,
      @JsonKey(name: 'url_resolved') String url,
      @JsonKey(name: 'favicon') String iconUrl});
}
...
extension DataRadioStationPatterns on DataRadioStation {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DataRadioStation value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, @JsonKey(name: 'url_resolved') String url,
            @JsonKey(name: 'favicon') String iconUrl)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _DataRadioStation() when $default != null:
        return $default(_that.name, _that.url, _that.iconUrl);
      case _:
        return orElse();
    }
  }
...
class _DataRadioStation implements DataRadioStation {
  const _DataRadioStation(
      {required this.name,
      @JsonKey(name: 'url_resolved') required this.url,
      @JsonKey(name: 'favicon') required this.iconUrl});
  factory _DataRadioStation.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DataRadioStationCopyWith<_DataRadioStation> get copyWith =>
      __$DataRadioStationCopyWithImpl<_DataRadioStation>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DataRadioStationToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$DataRadioStationCopyWith<$Res>
    implements $DataRadioStationCopyWith<$Res> {
  factory _$DataRadioStationCopyWith(
          _DataRadioStation value, $Res Function(_DataRadioStation) _then) =
      __$DataRadioStationCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
