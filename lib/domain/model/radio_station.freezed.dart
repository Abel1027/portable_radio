...
mixin _$RadioStation {
 ...
 String get name; Uri get uri; Uri get iconUri;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RadioStation&&(identical(other.name, name) || other.name == name)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.iconUri, iconUri) || other.iconUri == iconUri));
}
...
@useResult
$Res call({
 String name, Uri uri, Uri iconUri
});
...
/// Create a copy of RadioStation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? uri = null,Object? iconUri = null,}) {
  return _then(_self.copyWith(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,uri: null == uri ? _self.uri : uri // ignore: cast_nullable_to_non_nullable
as Uri,iconUri: null == iconUri ? _self.iconUri : iconUri // ignore: cast_nullable_to_non_nullable
as Uri,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  Uri uri,  Uri iconUri)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RadioStation() when $default != null:
return $default(_that.name,_that.uri,_that.iconUri);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  Uri uri,  Uri iconUri)  $default,) {final _that = this;
switch (_that) {
case _RadioStation():
return $default(_that.name,_that.uri,_that.iconUri);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  Uri uri,  Uri iconUri)?  $default,) {final _that = this;
switch (_that) {
case _RadioStation() when $default != null:
return $default(_that.name,_that.uri,_that.iconUri);case _:
  return null;
...
class _RadioStation implements RadioStation {
  const _RadioStation({required this.name, required this.uri, required this.iconUri});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RadioStation&&(identical(other.name, name) || other.name == name)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.iconUri, iconUri) || other.iconUri == iconUri));
}
...
/// Create a copy of RadioStation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? uri = null,Object? iconUri = null,}) {
